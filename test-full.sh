...
pocarchitect --url https://github.com/rikterskale/POCArchitect-AI-Agent --provider openai
echo "✅ Single URL test completed"
echo

# 4. Real Operator Flags Test (OpenAI)
...
echo "📄 Batch index created: ./reports/index.md"
echo
