...
| LINUX-02 | `python -m pocarchitect preflight --offline --output-dir ./reports` | Installation and selected output path checks run without provider access; Git is checked only for grounded runs |
