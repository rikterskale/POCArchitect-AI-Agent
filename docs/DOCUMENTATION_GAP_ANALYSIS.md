...
| Defaults | Provider models are `grok-4.6`, `gpt-4o`, `openai/gpt-oss-120b`, and `qwen2.5-coder:14b`; temperature is `0.2`; labels are `High`/`Linux`. `pocarchitect/config.py:14-27`. | Effective defaults are documented in the README, generated reference, and architecture. `README.md:178-187`; `docs/architecture.md:200-209`. | The provider model map and prompt compatibility boundary are now documented. |
...
<!-- closure-evidence-sha256: 2599d953c07c68480afa61aac8efc8609084b1c4120fc29610b251c9c559a32f -->
...
| DOC-023 | Closed | `pocarchitect/config.py:14-25`; `README.md:216-228`; `pocarchitect/POC_Architect_Prompt.md:1-3` | All four model defaults are published from shared constants and Claude/Gemini wording is explicitly bounded to prompt portability. |
...
| DOC-026 | Closed | `docs/guides/WINDOWS_NOVICE_USABILITY_GUIDE.md:1-10`; `docs/guides/LINUX_NOVICE_USABILITY_GUIDE.md:1-10`; `scripts/validate_novice_guides.py:86-107`; `tests/test_novice_guides.py:29-34` | Platform pages are concise deltas linked to the canonical guide; validation checks platform content and ledgers instead of enforcing duplicated heading counts. |
| DOC-027 | Closed | `docs/DOCUMENTATION_REVIEW_REPORT.md:1-9`; `README.md:340-357`; `scripts/validate_documentation_reports.py:141-159` | The prior report has a top historical-snapshot banner, both reports are accurately characterized in navigation, and CI enforces those boundaries. |
