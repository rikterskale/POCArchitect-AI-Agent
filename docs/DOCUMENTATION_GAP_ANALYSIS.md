...
<!-- closure-evidence-sha256: 3122a1802b65ad955359bb5eacd9746ba2506da82ef0677a09c8e7f8c4a1f953 -->
...
| DOC-018 | Closed | `docs/command-guide.md:346-377`; `.github/workflows/ci.yml:39-205`; `scripts/release_readiness.py:64-110`; `scripts/release_readiness.py:251-272`; `scripts/release_readiness.py:305-317`; `scripts/release_readiness.py:622-654`; `tests/test_release_readiness.py:21-27` | The local reproduction section mirrors quality, documentation, tests, security, Docker, release-readiness, build, and distribution gates while labeling hosted-only outcomes; release readiness inventories options by command path, probes the preflight output directory, and verifies noninteractive source-transfer refusal and `--yes` approval against a hermetic provider. |
